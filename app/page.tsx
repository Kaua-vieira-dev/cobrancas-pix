      ...
      <aside className="w-64 border-r border-zinc-800/60 bg-[#0f0f11] flex-col hidden md:flex">
        <div className="flex h-20 items-center px-6">
          <div className="flex items-center gap-2 font-bold text-lg">
            <div className="w-6 h-6 bg-white text-black rounded-md flex items-center justify-center text-xs">
              F
            </div>
            Fluxo
          </div>
                ...
                {!cobrancas || cobrancas.length === 0 ? (
                  ...
                  cobrancas.map((cobranca, index) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-10 h-10 rounded-full flex items-center justify-center bg-zinc-800/80`}
                        >
                          <span className="text-sm font-medium">
                            {cobranca.cliente_nome.charAt(0).toUpperCase()}
                          </span>
                        </div>
                        <div>
                      ...
                      <div className="flex flex-col md:flex-row items-end md:items-center gap-4">
                        <div className="text-right">
                          ...
                          <p
                            className={`text-xs ${cobranca.status === "pago" ? "text-emerald-400" : "text-yellow-500"}`}
                          >
